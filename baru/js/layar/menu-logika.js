...
export const MN_LAYAR = [
  ...
  { nama: 'Belanja ke pemasok', sub: 'isi truk, kapan habis, daftar belanja, kirim pesanan WhatsApp', tujuan: { ke: 'harga', keluarga: 'belanja', teks: 'buka Harga & Pemasok → Belanja' } }, { nama: 'Laba & neraca (sistem lama)', sub: 'laporan', tujuan: { ke: 'lama', halaman: 'Laba', teks: 'sistem lama' } },
