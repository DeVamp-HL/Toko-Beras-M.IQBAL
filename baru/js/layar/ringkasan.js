...
export function pasangLayarRingkasan(akar, opsi) {
  ...
  function perbarui(sebab) {
    ...
    const k = kini(); const r = R.susunRingkasan(skala, ix, k); const kas = R.susunKas(k); const perhatian = R.susunPerhatian().concat(perhatianPajak(k)); const sumber = sumberData();
