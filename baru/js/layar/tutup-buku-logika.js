...
export function gerbangBuku(tahun, kini, lokal, lewati) {
  ...
  const g = [
    ...
    { id: 'g4', teks: 'Tidak ada karcis kasir yang belum dirinci / dirapikan', ok: karcis === 0, ket: karcis ? karcis + ' nota menunggu dirinci atau dirapikan' : 'tidak ada', aksi: karcis ? 'Rinci di sistem lama (Jual → karcis)' : '', bisaLewati: false },
