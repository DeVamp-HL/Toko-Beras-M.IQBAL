...
ok('laci produksi: 1 adukan bulan ini; tutup buku: belum pernah (era kosong), tidak awas karena bukunya baru tahun ini', br('produksi').angka === '1 adukan' && br('tutupBuku').angka === 'belum pernah' && br('tutupBuku').awas === false && br('tutupBuku').tujuan.halaman === 'Setelan', J([br('produksi'), br('tutupBuku')]));
